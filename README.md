# Applied AI Document QA & RAG System
...
A high-performance, modular **Retrieval-Augmented Generation (RAG)** application engineered with **FastAPI**, recursive text chunking, dense subword embeddings, vector similarity search, and source-grounded LLM synthesis.
...
```bash
git clone https://github.com/MishaelOliva/ai-doc-rag.git
cd ai-doc-rag
