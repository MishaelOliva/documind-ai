...
| **Retrieval Latency (Mean)** | **9.20 ms** | &le; 20 ms | &check; Optimal |
| **Retrieval Latency (P95)** | **11.06 ms** | &le; 50 ms | &check; Optimal |
| **End-to-End Latency (P50)**| **9.06 ms** | &le; 100 ms (Offline) | &check; Optimal |
